...
class Calendar extends Component {
  static propTypes = {
    ...
    // Hide month navigation arrows for months outside the min and max days. Default = false
    // TODO: figure out how/where the defaults are set.
    hideArrowsPastMinMaxDays: PropTypes.bool,
  ...
  render() {
    ...
    // TODO: proptypes for new props below and handle unexpected input
    let hideLeftArrow = false;
    let hideRightArrow = false;
    if (
      this.props.hideArrowsPastMinMaxMonths &&
      this.props.minMonthDate &&
      this.props.maxMonthDate
    ) {
      /*
